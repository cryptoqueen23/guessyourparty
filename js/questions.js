...
// Tie-breaker pool — separate from QUESTIONS above, never asked in the main
// quiz. Used only when a result is too close to call (see results.js); 5 are
// chosen at random. Same schema as QUESTIONS, all weight 3 (highly
// polarizing) since these exist specifically to sharpen a close result.
const TIEBREAKER_QUESTIONS = [
  { id: "tb1", category: "Taxes", text: "The federal government should implement a wealth tax on individuals with over $50 million in assets.", rAnswer: "no", weight: 3,
    explanation: "This asks about a new annual tax specifically on very large net-worth holdings, separate from income tax.",
    benefit: "Supporters say it raises revenue from the wealthiest households without touching income tax rates.",
    tradeoff: "Critics say it's difficult to value and enforce, and could push wealth or investment out of the country.",
    impact: { taxes: "Would create a new tax category for the highest net-worth households.", spending: "Could fund new federal programs.", debt: "Could modestly reduce deficit if enforced as projected." } },
  { id: "tb2", category: "Healthcare", text: "The United States should transition to a single-payer, government-run healthcare system.", rAnswer: "no", weight: 3,
    explanation: "This asks whether private health insurance should be replaced by one government-run plan covering everyone.",
    benefit: "Supporters say it guarantees universal coverage and simplifies billing.",
    tradeoff: "Critics say it would eliminate private insurance choice and cost trillions in new federal spending.",
    impact: { taxes: "Would likely require significant new tax revenue.", spending: "Major increase in federal healthcare spending.", debt: "Could add substantially to long-run federal costs." } },
  { id: "tb3", category: "Immigration", text: "There should be a significant increase in the number of legal immigration visas issued each year.", rAnswer: "no", weight: 3,
    explanation: "This asks about expanding the total number of employment- and family-based visas issued annually.",
    benefit: "Supporters say it addresses labor shortages and reduces incentive for unauthorized entry.",
    tradeoff: "Critics say it could depress wages in some sectors and strain public services.",
    impact: { taxes: "No direct tax effect.", spending: "Modest increase in processing and services costs.", debt: "No significant effect." } },
  { id: "tb4", category: "Gun Rights", text: "Semi-automatic rifles commonly called \"assault weapons\" should be banned for civilian sale.", rAnswer: "no", weight: 3,
    explanation: "This asks about a federal ban on the sale of semi-automatic rifles matching a defined set of features.",
    benefit: "Supporters say it could reduce the availability of weapons used in mass-casualty shootings.",
    tradeoff: "Critics say it would infringe on lawful ownership and that similar bans have had limited measurable effect.",
    impact: { taxes: "No direct tax effect.", spending: "Minor enforcement costs.", debt: "No significant effect." } },
  { id: "tb5", category: "Abortion", text: "Abortion should be legal nationwide up to the point of fetal viability.", rAnswer: "no", weight: 3,
    explanation: "This asks about a federal standard legalizing abortion up to roughly 24 weeks of pregnancy nationwide.",
    benefit: "Supporters say it guarantees consistent access regardless of state law.",
    tradeoff: "Critics say abortion policy should be left to states and object on moral grounds to a viability-based standard.",
    impact: { taxes: "No direct tax effect.", spending: "No significant federal spending effect.", debt: "No significant effect." } },
  { id: "tb6", category: "Public Education", text: "Public funds should be usable for tuition at private and religious K-12 schools (school vouchers).", rAnswer: "yes", weight: 3,
    explanation: "This asks whether families should be able to direct public per-student education funding toward private school tuition.",
    benefit: "Supporters say it gives families more choice, especially those in underperforming school districts.",
    tradeoff: "Critics say it diverts funding away from public schools that serve the majority of students.",
    impact: { taxes: "No direct tax effect.", spending: "Redirects existing education spending rather than adding new spending.", debt: "No significant effect." } },
  { id: "tb7", category: "Domestic Energy Production", text: "The federal government should end new leases for oil and gas drilling on public lands.", rAnswer: "no", weight: 3,
    explanation: "This asks whether the federal government should stop issuing new leases for fossil fuel extraction on federally owned land.",
    benefit: "Supporters say it reduces carbon emissions and protects public land.",
    tradeoff: "Critics say it reduces domestic energy production and related state and federal royalty revenue.",
    impact: { taxes: "No direct tax effect.", spending: "No significant effect.", debt: "Could reduce federal royalty revenue." } },
  { id: "tb8", category: "Criminal Justice", text: "Private, for-profit prisons should be banned at the federal level.", rAnswer: "no", weight: 3,
    explanation: "This asks whether the federal government should stop contracting with privately operated prisons.",
    benefit: "Supporters say it removes a profit motive from incarceration decisions.",
    tradeoff: "Critics say it could raise short-term costs and reduce capacity in an already strained system.",
    impact: { taxes: "No direct tax effect.", spending: "Could raise near-term incarceration costs.", debt: "Minor, long-term effect." } },
  { id: "tb9", category: "Foreign Policy", text: "The U.S. should significantly reduce its overseas military presence and alliance commitments.", rAnswer: "no", weight: 3,
    explanation: "This asks about scaling back U.S. troop deployments and formal defense commitments abroad.",
    benefit: "Supporters say it reduces military spending and risk of foreign entanglement.",
    tradeoff: "Critics say it could weaken alliances and embolden rival powers.",
    impact: { taxes: "No direct tax effect.", spending: "Could reduce defense spending over time.", debt: "Could modestly ease long-run spending pressure." } },
  { id: "tb10", category: "Voter ID", text: "All voters should be required to show a government-issued photo ID to vote in federal elections.", rAnswer: "yes", weight: 3,
    explanation: "This asks whether photo identification should be a nationwide requirement to cast a ballot in federal elections.",
    benefit: "Supporters say it helps prevent voter fraud and increases confidence in results.",
    tradeoff: "Critics say it can create a barrier for voters who lack easy access to ID.",
    impact: { taxes: "No direct tax effect.", spending: "Minor cost for ID-assistance programs.", debt: "No significant effect." } },
  { id: "tb11", category: "Government Spending", text: "Federal spending on social safety-net programs (like SNAP and housing assistance) should be significantly increased.", rAnswer: "no", weight: 3,
    explanation: "This asks about expanding federal funding for food assistance, housing aid, and similar safety-net programs.",
    benefit: "Supporters say it reduces poverty and hardship for low-income households.",
    tradeoff: "Critics say it increases federal spending and may reduce incentive to work.",
    impact: { taxes: "No direct tax effect.", spending: "Would increase federal safety-net spending.", debt: "Could add to near-term federal costs." } },
  { id: "tb12", category: "Climate Policy", text: "The U.S. should commit to eliminating net carbon emissions by 2050 through binding federal mandates.", rAnswer: "no", weight: 3,
    explanation: "This asks about legally binding federal requirements to reach net-zero carbon emissions by a fixed date.",
    benefit: "Supporters say binding targets are necessary to meaningfully address climate change.",
    tradeoff: "Critics say mandates could raise energy costs and burden certain industries.",
    impact: { taxes: "No direct tax effect.", spending: "Could require new federal investment in clean energy.", debt: "Could add to near-term federal costs." } },
  { id: "tb13", category: "Border Security", text: "Federal funding for physical barriers along the U.S.-Mexico border should be significantly increased.", rAnswer: "yes", weight: 3,
    explanation: "This asks about expanding federal funding specifically for border wall or fencing construction.",
    benefit: "Supporters say physical barriers help deter unauthorized crossings in certain terrain.",
    tradeoff: "Critics say it's costly per mile and doesn't address other entry points like visa overstays.",
    impact: { taxes: "No direct tax effect.", spending: "Would increase federal border infrastructure spending.", debt: "Could add to near-term federal costs." } },
  { id: "tb14", category: "Death Penalty", text: "The federal death penalty should be abolished.", rAnswer: "no", weight: 3,
    explanation: "This asks whether capital punishment should be eliminated as a sentencing option in federal cases.",
    benefit: "Supporters say it removes the risk of executing an innocent person and avoids lengthy appeals costs.",
    tradeoff: "Critics say it removes the most severe consequence for the most serious federal crimes.",
    impact: { taxes: "No direct tax effect.", spending: "Could reduce long-run appeals-related costs.", debt: "No significant effect." } },
  { id: "tb15", category: "Mail-In Voting", text: "States should be required to offer no-excuse mail-in voting to all registered voters.", rAnswer: "no", weight: 3,
    explanation: "This asks whether every state should be federally required to let any registered voter vote by mail without needing a specific reason.",
    benefit: "Supporters say it increases access and turnout, especially for people who can't easily vote in person.",
    tradeoff: "Critics say it can complicate ballot verification and increase administrative burden on states.",
    impact: { taxes: "No direct tax effect.", spending: "Would increase state election administration costs.", debt: "No significant federal effect." } },
];
